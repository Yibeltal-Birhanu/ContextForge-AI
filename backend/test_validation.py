...
context = ImplementationContext(
    ...
    project_summary="An online supermarket for browsing and ordering products.",
    ...
    architecture_summary="Three-tier monolith with React, Node.js, PostgreSQL.",
...
def main():
    ...
    print("=" * 60)
    print("TEST 1: Real context (should pass)")
    print("=" * 60)
    ...
    print()
    print("=" * 60)
    print("TEST 2: Broken context (should fail)")
    print("=" * 60)
